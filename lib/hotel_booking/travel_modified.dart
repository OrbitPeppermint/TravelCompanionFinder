        ...
        children: [
          SingleChildScrollView(
            child: Column(
              children: [
        children: <Widget>[
          //TODO insert here the arrow_back button inside an Appbar while keeping it in the same position 
            ...
            Column(
                    children: <Widget>[
                      AspectRatio(
                        ...
                        child: Image.asset('assets/hotel/complement_picture01.png'),
                      ),
                    ],
                  ),
            Positioned(
                                    ...
                                    //child: Expanded(
                                      ...
                                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                        children: <Widget>[
                                          //TODO AWS
                                          Expanded(
                                            child: getTimeBoxUI('24', 'people'),),
                                          Expanded( 
                                            child: getTimeBoxUI('3', 'Days'),),
                                          //beds or seats? if beds which bed size? => bed? queen size? king size?
                                          Expanded(
                                            child: getTimeBoxUI('2', 'Beds free')),
                                        ],
                                      ),
                                ...
                                AnimatedOpacity(
                                      ...
                                      child:  Padding(
                                        ...
                                        //   children: <Widget>[
                                                    ...
                                                    if (_isOverflowing)
                                                      ...
                                                      GestureDetector(
                                                        ...
                                                        onTapUp: (_) {
                                                          ...
                                                          //TODO ist aber schon unten dabei bei _showFullTextOverlay dabei
                                                          //Navigator.push(context, MaterialPageRoute(builder: (context) => const _showFullTextOverlay(context, textContent)));
                                          ...
                                          //] 
                                        //),
                                        //TODO const padding from below inside a column with Row and Padding as a child, with NestedScrollView nescessary?
                                      ),
                                    ),
                                //),
                                              ...
                                              children: <Widget>[
                                                  ...
                                                  Column(
                                                    ...
                                                    children:[
                                                      ...
                                                      Text(
                                                        'Nana BTS Station Exit 3, Bangkok',
                                                        textAlign: TextAlign.left,
                                                        style: TextStyle(
                                                          fontWeight: FontWeight.w200,
                                                          fontSize: 14,
  ...
  Navigator.of(context).push(
    MaterialPageRoute(
      ...
      builder: (BuildContext context) {
        //TODO stattdessen Klasse übergeben für Swipe back?
        return Material(
          color: AppTheme.nearlyWhite,
          child: Stack(
        children: [
